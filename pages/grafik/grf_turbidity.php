...
<script type="text/javascript">
    ...
    function () {
       $('#load_intake').load('reload.php').fadeIn("slow");
        ...
        <div   class="col-md-6">
          ...
          <div id="load" class="box box-warning ">
            ...
            <div id="load_intake" class="box-body"> 
...
?>
        ...
        <div   class="col-md-6">
          ...
          <div  class="box box-info ">
            ...
            <div id="load_resvo" class="box-body">
           
          
  <script type="text/javascript">
    var auto_refresh_resvo = setInterval(
    function () {
       $('#load_resvo').load('reload_resvo.php').fadeIn("slow");
    }, 1000); // refresh setiap 10000 milliseconds
</script>
...
$waktu = mysqli_query($koneksi, "SELECT  waktu FROM monitoring ORDER BY waktu DESC LIMIT 24");
